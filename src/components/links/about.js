...
const  About = () => {
        return (
            <div className="container row">
                ...
                <h6>Github: <a href='https://github.com/its-nedum' target="_blank" rel="noopener noreferrer"> its-nedum</a></h6>
                <h6>Twitter: <a href='https://www.twitter.com/its_nedum' target="_blank" rel="noopener noreferrer">its_nedum</a></h6>
